...
use \Volleyball\Component\Resource\Exception\Driver\InvalidDriverException;

abstract class AbstractUtilityExtension extends Extension
{
    ...
    protected $applicationName = 'volleyball';
